...
{	
	...
	UPROPERTY(EditAnywhere,BlueprintReadWrite, Category="FRandomActorRotation")
	bool bRandomizeRotYaw = false;

	UPROPERTY(EditAnywhere,BlueprintReadWrite, Category="FRandomActorRotation", meta = (EditCondition = "bRandomizeRotYaw"))
	...
	UPROPERTY(EditAnywhere,BlueprintReadWrite, Category="FRandomActorRotation", meta = (EditCondition = "bRandomizeRotPitch"))
	...
	UPROPERTY(EditAnywhere,BlueprintReadWrite, Category="FRandomActorRotation", meta = (EditCondition = "bRandomizeRotRoll"))
